"""
Django settings for waistedbackend project.
...
SECRET_KEY = 'django-insecure-q&g4%oz2nwazxdudh9utb4w8s6^d-#&ohrio7**z(yfy$(uz+5'
...
ROOT_URLCONF = 'waistedbackend.urls'
...
WSGI_APPLICATION = 'waistedbackend.wsgi.application'
